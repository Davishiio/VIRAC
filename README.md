# ROVER: Robot Orientado a Visión, Exploración y Reconocimiento.
ROVER es un vehículo autónomo a escala 1/12 que integra control remoto, visión por computadora 3D y navegación inteligente. Esta guía está pensada para que un alumno o colaborador pueda montar, configurar y operar el vehículo sin depender del autor original.
#Hardware
#2. Componentes
